...
const Home: NextPage = () => {
  ...
  return (
    // *********여기서부터 지역구분하면 됌!!!!!!!!!!!!!1
    // <Link ref>
    <div key={1} className="flex-wrap dark:bg-[#2a313c]">
      {/* <input
        // type={"button"}
        // id={"서울"}
        onChange={(e) => setInput(e.currentTarget.value)}
      ></input> */}
      <h1 className="font-bold text-3xl text-center py-9 ">지역 축제 정보 </h1>
      <span className="bg-[#ffd966] border-y-2 border-black ml-16 py-8">
        <span className="ml-16"> 관심있는 지역의 축제 정보를 확인하세요! </span>
        <select
          ...
          // value={type}
        >
          <option hidden>지역을 선택하세요</option>
